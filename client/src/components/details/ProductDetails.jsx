    ...
    return (
                    <>
                            ...
                            <Typography style={{ marginTop:5, color: '#878787', fontSize: 14 }}>
                                8 Ratings & 1 Reviews
                                <Box component="span"><img src={fassured} alt="F_assured" style={{ width: 77, marginLeft: 20 }}/></Box>
                            </Typography>
                            <Typography>
                            ...
                            <SmallText>
                                ...
                                <Typography><StyledBadge />No Cost EMI on Bajaj Finanace EMI Card on cart value above ₹2999 T&C</Typography>
                            </SmallText>
                            <Table>
                                <TableBody>
                                    <ColumnText>
                                    ...
                                    <ColumnText>
                                        ...
                                        <TableCell>Hello guys, hurry up!! offer is for limited time only.</TableCell>
                                    </ColumnText>
                                </TableBody>
                            </Table>
                    </>
